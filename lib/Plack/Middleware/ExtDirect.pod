...
To configure Plack::Middleware::ExtDirect instance, you will need
to create an instance of L<RPC::ExtDirect::Config> with all required
options set, and pass it to Plack::Middleware::ExtDirect
L<constructor|/new> to be used. This step is optional; by default the
Config instance in the L<global API instance|/"GLOBAL API TREE INSTANCE">
